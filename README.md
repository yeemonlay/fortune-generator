...
- Lightweight one-page web app (no backend required)

## Tech Stack
- HTML
- CSS
- JavaScript
Fortune messages are generated using:
https://fungenerators.com/random/text/fortune-cookie

## How to Run
1. Clone the repository
git clone https://github.com/yourusername/fortune-generator.git
